                ...
                <div class="row">
                    <div class="four columns">
                        <ul class="nav-bar vertical">
                            ...
                            <li id="update"><a href="<?php echo pf_config::get('main_page')?>/server/update"><img src="<?php echo pf_config::get('base_url');?>/app/assets/site_images/used/update.png"/>&nbsp;Update Bukkit</a></li>
                        </ul>
                    </div>
